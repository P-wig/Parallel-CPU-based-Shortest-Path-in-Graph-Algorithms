...
\textbf{Bellman-Ford} demonstrates good scaling behavior, achieving a 2.6 times speedup with 16 threads. 
...
With 16 threads, the algorithm runs 1.9 times \textit{slower} than the single-threaded version. 
...
@misc{dimacs-internet-egr,
  title = {DIMACS Implementation Challenge: ECLgraph Benchmark Suite},
  howpublished = {\url{https://userweb.cs.txstate.edu/~mb92/research/ECLgraph/index.html}},
  note = {Accessed: 2025-12-01}
}

@misc{garg-sssp-notes,
  author = {Vijay K. Garg},
  title = {Lecture Notes: Single Source Shortest Path Algorithms},
  year = {2025},
  note = {Course notes, University of Texas at Austin}
}